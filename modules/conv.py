...
class ConditionedDown(nn.Module):
    BATCH_SIZE = 20
    def __init__(self, in_channels, out_channels, word_embed_size: int):
        super().__init__()
...
class OutConv(nn.Module):
    def __init__(self, in_channels, act: nn.Module = nn.Sigmoid()):
